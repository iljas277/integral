...
void test_integral(void){
    ...
    double I1 = integral(i_func1, 0.0, 2.0, 0.000001);
    printf("Calculated integral: %.5f\n", I1);
    if (fabs(I1 - 2.0) < 0.001){
    ...
    double I2 = integral(i_func2, -1.0, 2.0, 0.000001);
    printf("Calculated integral: %.5f\n", I2);
    if (fabs(I2 - 3.0) < 0.001){
        printf("Правильно найден интеграл\n");
    }
    else {
        printf("Ошибка при нахождении интеграла\n");
    ...
    double I3 = integral(i_func3, -1.0, 2.0, 0.000001);
    printf("Calculated integral: %.5f\n", I3);
    if (fabs(I3 - 13.5) < 0.001){
        printf("Правильно найден интеграл\n");
    }
    else {
        printf("Ошибка при нахождении интеграла\n");
    ...
    double I4 = integral(i_func4, -1.0, 2.0, 0.000001);
    printf("Calculated integral: %.5f\n", I4);
    if (fabs(I4 - 7.02117) < 0.001){
        printf("Правильно найден интеграл\n");
    }
    else {
        printf("Ошибка при нахождении интеграла\n");
